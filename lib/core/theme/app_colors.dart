...
class AppColors {
  ...
  static const Color warning = Color(0xFFFFB786);
  static const Color warningContainer = Color(0xFFDF7412);

  // Champs clairs visibles dans la maquette
  static const Color inputBackground = Color(0xFFF7F8FC);
  static const Color inputText = Color(0xFF111827);
  static const Color inputHint = Color(0xFF7B8190);

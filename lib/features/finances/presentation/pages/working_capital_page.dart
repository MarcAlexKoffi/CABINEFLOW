          ...
          if (snapshot.hasError) {
            return Center(
              child: Padding(
                ...
                child: Text(
                  'Impossible de calculer le fonds de roulement : ${snapshot.error}',
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: fund.netWorkingCapital >= 0
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      formatCfaFull(fund.netWorkingCapital),
                    ...
                    Text(
                      'Liquidité opérationnelle ${formatCfa(fund.operatingLiquidity)}',
                      style: const TextStyle(
                        color: Colors.white70,
                        fontSize: 11,
                      ),
                ...
                children: [
                  Expanded(
                    child: FinancialMetricCard(
                      ...
                      value: formatCfa(fund.waveBalance),
                  ...
                  Expanded(
                    child: FinancialMetricCard(
                      label: 'Réseaux libres',
                      value: formatCfa(fund.freeNetworkBalance),
                      icon: Symbols.cell_tower_rounded,
                      accent: IzyTelColors.primary,
                      caption: '${formatCfa(fund.networkCommitted)} engagés',
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  Expanded(
                    child: FinancialMetricCard(
                      ...
                      value: formatCfa(fund.customerReceivables),
                  ...
                  Expanded(
                    child: FinancialMetricCard(
                      ...
                      value: formatCfa(fund.supplierDebt),
              ...
              const SizedBox(height: 10),
              FinancialMetricCard(
                label: 'Commissions dues aux Agents',
                value: formatCfa(fund.commissionDebt),
                icon: Symbols.payments_rounded,
                accent: fund.commissionDebt > 0
              ...
              ...AgentNetwork.values.map((AgentNetwork network) {
                ...
                final int free = (item.available - item.committed)
                    .clamp(0, item.available)
                    .toInt();
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      Text(
                        'Engagé ${formatCfa(item.committed)}',
                        style: const TextStyle(
                          fontSize: 11,
              ...
              Container(
                ...
                child: Text(
                  'Calcul : Wave + stock réseau libre + créances clients - dettes fournisseurs - commissions dues. Le stock déjà engagé dans une commande payée n’est pas considéré comme libre.',

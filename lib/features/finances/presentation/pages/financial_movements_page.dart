...
enum _MovementKind { payment, refund, commission }
              ...
              builder: (
                ...
                return StreamBuilder<List<CommissionPayout>>(
                  ...
                  builder: (
                    ...
                    final List<_FinancialMovement> all = <_FinancialMovement>[
                      ...orders
                          .where(
                            (QueueOrder order) =>
                    ...
                    final int incoming = all
                        .where((_FinancialMovement movement) => movement.amount > 0)
                        .fold<int>(0, (int total, _FinancialMovement movement) => total + movement.amount);
                    final int outgoing = all
                        .where((_FinancialMovement movement) => movement.amount < 0)
                        .fold<int>(0, (int total, _FinancialMovement movement) => total + movement.amount.abs());
                          ...
                          child: visible.isEmpty
                              ? const SingleChildScrollView(
                                  child: FinanceEmptyState(
                                    ...
                                    message:
                                        'Les paiements confirmés, remboursements et commissions payées apparaîtront ici.',
                                  ),
                                )
                              : ListView.separated(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    return _MovementRow(movement: visible[index]);
                                  },
                                ),
                        ),
                      ],

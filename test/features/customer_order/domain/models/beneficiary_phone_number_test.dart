  ...
  group('BeneficiaryPhoneNumber', () {
    test('normalise un numéro local ivoirien', () {
      final BeneficiaryPhoneNumber number =
          BeneficiaryPhoneNumber.parse('07 12 34 56 78');
    ...
    test('accepte un numéro déjà préfixé par +225', () {
      final BeneficiaryPhoneNumber number =
          BeneficiaryPhoneNumber.parse('+225 05 98 76 54 32');
    ...
    test('accepte le préfixe international 00225', () {
      final BeneficiaryPhoneNumber number =
          BeneficiaryPhoneNumber.parse('00225 01 02 03 04 05');
    ...
    test('refuse un préfixe mobile non pris en charge', () {
      expect(
        BeneficiaryPhoneNumber.validate('03 12 34 56 78'),
        isNotNull,
      );
    });
    ...
    test('refuse un numéro trop court', () {
      expect(
        BeneficiaryPhoneNumber.validate('07 12 34'),
        isNotNull,
      );
    });
  });

...
void main() {
  ...
  test('caisse Wave ne comptabilise que les flux postérieurs au solde d’ouverture et payés via Wave', () {
  ...
  test('fonds de roulement tient compte du réseau libre, des créances et des dettes', () {
  ...
  test('clôture estime la marge avec le coût moyen réel des recharges fournisseurs', () {
  ...
  test('le coût économique reste basé sur le principal même si le fournisseur est déjà réglé', () {
  ...
  test('un remboursement d’une commande jamais exécutée ne crée pas une fausse perte de bénéfice', () {
